    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={{ flex: 1, alignItems: "center" }}>
          <Image
            source={require("../assets/icons/sneaker-icon.png")}
            style={{
              width: 40,
              height: 30,
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          <Image
            source={require("../assets/login/profile-img.png")}
      ...
      {/* Line */}
      <View
        style={{ borderWidth: 0.4, borderColor: Colors.textPrimary }}
      ></View>

      {/* Profile options */}
      <View style={{ marginTop: 30 }}>
        <TouchableOpacity
          style={{ flexDirection: "row", padding: 17, marginBottom: 10 }}
        >
          <Feather
            name="settings"
            size={24}
          ...
          />
          <Text style={{ fontSize: 16, color: Colors.titleColor }}>
            Settings
          </Text>
          <View style={{ flex: 1, alignItems: "flex-end" }}>
            <Ionicons
